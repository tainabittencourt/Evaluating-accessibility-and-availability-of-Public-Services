...
#set_billing_id("base-dos-dados-370619")

#query <- "SELECT * FROM `basedosdados.br_ms_cnes.estabelecimento`"
#dir <- tempdir()
#data <- download(query, path = "H:/Meu Drive/Doc/Analysis/OBT/CNES/dados.csv")

# Para carregar o dado direto no R
#query <- bdplyr("br_ms_sim.municipio_causa_idade")
#df <- bd_collect(query)
...
colnames(corr) <- c("urban optimum","minimum time","15-min cum.","30-min cum.","15-min 2SFCA","30-min 2SFCA")
